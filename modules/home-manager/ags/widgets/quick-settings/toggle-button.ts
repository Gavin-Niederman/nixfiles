...
type ToggleButtonProps<
  ToggleButtonChild extends Gtk.Widget,
  RevealerChild extends Gtk.Widget,
> = BindableProps<{
...
export function ToggleButton<
  ToggleButtonChild extends Gtk.Widget,
  RevealerChild extends Gtk.Widget,
>(props: ToggleButtonProps<ToggleButtonChild, RevealerChild>) {
  ...
  return Widget.Box({
    classNames: classes,
    vertical: true,
    children: [toggleButton, revealer],
  });
}
